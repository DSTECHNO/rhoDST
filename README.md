...
# Features
 ...
 - Continuity, momentum and energy equations are implicity coupled in a single matrix.  The block-matrix can be solved using block-matrix solvers available in foam-extend libraries such as GMRES, BICG and multigrid methods. 
