...
#include "farFieldPressureDSTFvPatchScalarField.H"
...
farFieldPressureDSTFvPatchScalarField::farFieldPressureDSTFvPatchScalarField
(
    const fvPatch& p,
...
farFieldPressureDSTFvPatchScalarField::farFieldPressureDSTFvPatchScalarField
(
    const farFieldPressureDSTFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
void farFieldPressureDSTFvPatchScalarField::updateCoeffs()
{
    if (this->updated())
    {
        return;
    ...
    this->refValue() = 
        (
            supersonicInflow * pInf_
          + subsonicInflow * pb
          + subsonicOutflow * pInf_
        );
    
    this->valueFraction() = 1 - supersonicOutflow - 0.5*subsonicInflow;

    mixedFvPatchScalarField::updateCoeffs();
}


void farFieldPressureDSTFvPatchScalarField::write(Ostream& os) const
{
...
makePatchTypeField(fvPatchScalarField, farFieldPressureDSTFvPatchScalarField);
